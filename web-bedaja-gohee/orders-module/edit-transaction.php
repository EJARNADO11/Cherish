...
<div id="form-block" >
  ...
  <form method="POST" action="processes/process.orders.php?action=delete">
                <span><button type="submit" name="ord_id"  value="<?php echo $orders->get_order_id($id);?>"><a>Delete</a></button></span>
            </form>
</div>